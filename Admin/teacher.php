...
<div class="outer-w3-agile col-xl ml-xl-3 mt-xl-0 mt-3 report">
                        <h4 class="tittle-w3-agileits mb-4">Teachers</h4>
...
<center>
    ...
    <div class="input-group">
     ...
     <input type="text" name="search_text" id="search_text" placeholder="Search teachers" aria-label="Search" class="form-control mr-sm-2" />
    </div>
   </div>
<br />
    <div id="result"></div>
