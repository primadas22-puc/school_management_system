...
?>
         <tr>
         <td><input type="hidden" name="id<?php echo $x; ?>" value="<?php echo $id; ?>"><?php echo $id; ?></td>
         <td><input type="hidden" name="n<?php echo $x; ?>" value="<?php echo $name; ?>"><?php echo $name; ?></td>
         <td>
            <select name="class<?php echo $x; ?>">
